...
public class myGrammarParser extends Parser {
	...
	public final FunctionDeclContext functionDecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(205); match(Def);
			setState(206); match(DataType);
			setState(207); match(Identifier);
			setState(208); match(OpenParen);
			setState(210);
			_la = _input.LA(1);
			if (_la==DataType) {
				{
				setState(209); paramIdList();
				}
			}

			setState(212); match(CloseParen);
			setState(213); functionBlock();
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(284); functionCall();
				setState(286);
				switch ( getInterpreter().adaptivePredict(_input,23,_ctx) ) {
				case 1:
					{
					setState(285); indexes();
					}
					break;
				}
				}
			...
			case 10:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(300); match(OpenParen);
				setState(301); expression(0);
				setState(302); match(CloseParen);
				setState(304);
				switch ( getInterpreter().adaptivePredict(_input,27,_ctx) ) {
				case 1:
					{
					setState(303); indexes();
					}
					break;
				}
				}
			...
			case 11:
				...
				setState(307); match(Period);
				setState(308); match(Length);
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(312); match(Pow);
						setState(313); expression(26);
						}
						break;
					case 2:
						{
						...
						setState(315); match(Multiply);
						setState(316); expression(25);
						}
						break;
					case 3:
						{
						...
						setState(318); match(Divide);
						setState(319); expression(24);
						}
						break;
					case 4:
						{
						...
						setState(321); match(Modulus);
						setState(322); expression(23);
						}
						break;
					case 5:
						{
					...
					case 7:
						...
						setState(330); match(GTEquals);
						setState(331); expression(20);
						}
						break;
					case 8:
						{
						...
						setState(333); match(LTEquals);
						setState(334); expression(19);
						}
						break;
					case 9:
						{
						...
						setState(336); match(GreatThan);
						setState(337); expression(18);
						}
						break;
					case 10:
						{
						...
						setState(339); match(LessThan);
						setState(340); expression(17);
						}
						break;
					case 11:
						{
					...
					case 12:
						...
						setState(345); match(NEquals);
						setState(346); expression(15);
						}
						break;
					case 13:
						{
						...
						setState(348); match(And);
						setState(349); expression(14);
						}
						break;
					case 14:
						{
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(364); match(OpenBracket);
			setState(366);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Writeln) | (1L << Write) | (1L << Null) | (1L << Exclamation) | (1L << OpenBracket) | (1L << OpenParen) | (1L << Bool) | (1L << Number) | (1L << Identifier) | (1L << String))) != 0)) {
				{
			...
			setState(368); match(CloseBracket);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(370); match(OpenBracket);
