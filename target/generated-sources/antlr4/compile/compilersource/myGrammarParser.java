...
public class myGrammarParser extends Parser {
	...
	public final IdentifierDeclarationContext identifierDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==OpenBracket) {
				{
				setState(115); match(OpenBracket);
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			case Identifier:
				...
				setState(122); match(OpenParen);
				setState(124);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Writeln) | (1L << Write) | (1L << Null) | (1L << Exclamation) | (1L << OpenBracket) | (1L << OpenParen) | (1L << Bool) | (1L << Number) | (1L << Identifier) | (1L << String))) != 0)) {
					{
					setState(123); exprList();
					}
				}
			...
			case Writeln:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(127); match(Writeln);
				setState(128); match(OpenParen);
				setState(130);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Writeln) | (1L << Write) | (1L << Null) | (1L << Exclamation) | (1L << OpenBracket) | (1L << OpenParen) | (1L << Bool) | (1L << Number) | (1L << Identifier) | (1L << String))) != 0)) {
					{
			...
			case Write:
				...
				setState(134); match(OpenParen);
				setState(135); expression(0);
				setState(136); match(CloseParen);
				}
				break;
			default:
	...
	public final FunctionDeclContext functionDecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(167); match(Def);
			setState(168); match(DataType);
			setState(169); match(Identifier);
			setState(170); match(OpenParen);
			setState(172);
			_la = _input.LA(1);
			if (_la==DataType) {
				{
				setState(171); paramIdList();
				}
			}

			setState(174); match(CloseParen);
			setState(175); functionBlock();
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(178); match(For);
				setState(179); match(DataType);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(239); match(Exclamation);
				setState(240); expression(25);
				}
				break;
			case 2:
				{
			...
			case 10:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(262); match(OpenParen);
				setState(263); expression(0);
				setState(264); match(CloseParen);
				setState(266);
				switch ( getInterpreter().adaptivePredict(_input,26,_ctx) ) {
				case 1:
					{
					setState(265); indexes();
					}
					break;
				}
				}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 9:
						...
						setState(295); match(GreatThan);
						setState(296); expression(17);
						}
						break;
					case 10:
						{
						...
						setState(298); match(LessThan);
						setState(299); expression(16);
						}
						break;
					case 11:
						{
					...
					case 12:
						...
						setState(304); match(NEquals);
						setState(305); expression(14);
						}
						break;
					case 13:
						{
					...
					case 14:
						...
						setState(310); match(Or);
						setState(311); expression(12);
						}
						break;
					case 15:
						{
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(323); match(OpenBracket);
			setState(325);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Writeln) | (1L << Write) | (1L << Null) | (1L << Exclamation) | (1L << OpenBracket) | (1L << OpenParen) | (1L << Bool) | (1L << Number) | (1L << Identifier) | (1L << String))) != 0)) {
				{
			...
			setState(327); match(CloseBracket);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			do {
				...
				case 1:
					...
					setState(331); match(CloseBracket);
					}
					}
					break;
				default:
