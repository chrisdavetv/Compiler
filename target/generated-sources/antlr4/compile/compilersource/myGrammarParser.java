...
public class myGrammarParser extends Parser {
	...
	public final FunctionDeclContext functionDecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(170); match(Def);
			setState(171); match(DataType);
			...
			if (_la==DataType) {
				{
				setState(174); paramIdList();
				}
			}

			setState(177); match(CloseParen);
			setState(178); functionBlock();
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(186); match(To);
				setState(187); expression(0);
				setState(188); match(Do);
				setState(189); block();
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(242); match(Exclamation);
			...
			case 10:
				...
				setState(267); match(CloseParen);
				setState(269);
				switch ( getInterpreter().adaptivePredict(_input,25,_ctx) ) {
				case 1:
					{
					setState(268); indexes();
					}
					break;
				}
				}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(277); match(Pow);
						setState(278); expression(26);
						}
						break;
					case 2:
						{
						...
						setState(280); match(Multiply);
						setState(281); expression(25);
						}
						break;
					case 3:
						{
						...
						setState(283); match(Divide);
						setState(284); expression(24);
						}
						break;
					case 4:
						{
						...
						setState(286); match(Modulus);
						setState(287); expression(23);
						}
						break;
					case 5:
						{
						...
						setState(289); match(Add);
						setState(290); expression(22);
						}
						break;
					case 6:
						{
						...
						setState(292); match(Subtract);
						setState(293); expression(21);
						}
						break;
					case 7:
						{
						...
						setState(295); match(GTEquals);
						setState(296); expression(20);
						}
						break;
					case 8:
						{
						...
						setState(298); match(LTEquals);
						setState(299); expression(19);
						}
						break;
					case 9:
						{
						...
						setState(301); match(GreatThan);
						setState(302); expression(18);
						}
						break;
					case 10:
						{
						...
						setState(304); match(LessThan);
						setState(305); expression(17);
						}
						break;
					case 11:
						{
					...
					case 12:
						...
						setState(310); match(NEquals);
						setState(311); expression(15);
						}
						break;
					case 13:
						{
	...
	public final ListContext list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(329); match(OpenBracket);
			setState(331);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Writeln) | (1L << Write) | (1L << Null) | (1L << Exclamation) | (1L << OpenBracket) | (1L << OpenParen) | (1L << Bool) | (1L << Number) | (1L << Identifier) | (1L << String))) != 0)) {
				{
			...
			setState(333); match(CloseBracket);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					setState(335); match(OpenBracket);
