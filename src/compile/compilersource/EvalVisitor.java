...
//mismatched input errors still dont get caught
	...
	// test case a,b로 나눠진 거.
	// return 다음 줄에 내용 잇으면 애러나오
	// fix calcul
	// return expression? 을 묶어서 function별로 변수값으로 처리?
	// if else if 이런 곳에서 return 다음 statement 처리. (antlr?)
	// typeCheck에서 오류 나오면 다른 string값 줘서 assignment 무효화.
    class FunctionData{
