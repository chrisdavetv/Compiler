...
public class ExecutionManager {
    ...
    public static void initialize() {
            ...
            NotificationCenter.getInstance().addObserver(Notifications.ON_EXECUTION_FINISHED, (NotificationListener) sharedInstance);
    }
    ...
    public static void reset() {
            ...
            NotificationCenter.getInstance().removeObserver(Notifications.ON_EXECUTION_FINISHED, (NotificationListener) sharedInstance);
    }
     ...
     */
    public void openFunctionExecution(Function mobiFunction) {
