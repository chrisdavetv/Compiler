...
public interface myGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link myGrammarParser#functionBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionBlock(myGrammarParser.FunctionBlockContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link myGrammarParser#returnStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturnStatement(myGrammarParser.ReturnStatementContext ctx);
	/**
